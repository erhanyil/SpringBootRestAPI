package com.stdiosoft.restapi.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.stdiosoft.restapi.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.stdiosoft.restapi.model" });
